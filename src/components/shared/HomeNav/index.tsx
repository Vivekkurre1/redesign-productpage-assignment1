                ...
                <div className="flex justify-between h-16 items-center">
                    ...
                    <div className="hidden lg:flex space-x-8">
                        {menuItems.map((item) => (
                            <div
                                key={item.text}
                                className="text-[#ffffffc9] transition-all duration-300 hover:text-primary cursor-pointer"
                                onClick={() =>
                                    scrollToSection && item.ref
                                        ? scrollToSection(item.ref)
                            ...
                            {menuItems.map((item, i) => (
                                ...
                                >
                                    <div className="relative overflow-hidden">
                                        <div
                                            className={`text-lg font-medium text-gray-800 hover:text-primary transition-all duration-300 cursor-pointer hover:translate-x-2`}
                                        >
                                            {item.icon} {item.text}
                                        </div>
